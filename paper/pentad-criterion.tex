...
them, so that pentad or hexad infinitude \emph{via identities} is equivalent
to the class number statement or to multi-seed divisibilities.
...
$361, 505$): the mechanisms stack. A heuristic count (independent-values
...
\begin{enumerate}
  ...
  \item[(ii)] The fifth element requires the center, i.e.\ the open
    statement $h(-p) \equiv 3 \pmod 4$ infinitely often along
...
\end{enumerate}
Hence pentad or hexad infinitude via identities is \emph{equivalent} to the
class number statement (Hypothesis~\ref{hyp:cfs}) or to the multi-seed
divisibility statement (hypothesis of Corollary~\ref{cor:hexad}),
respectively. This explains precisely why the June 2026 state of the art
($k = 3$) is the natural ceiling of the entire classical toolkit.
\end{theorem}
